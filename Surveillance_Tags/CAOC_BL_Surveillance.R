...
sum(bl_surveil_ids$gisaid_accesion=="") #After removing non-surveillance samples, 1 was not accepted to GISAID


gisaid_df<-bl_surveil_ids[bl_surveil_ids$gisaid_accesion!="",]
gisaid_df<-gisaid_df[,c(2,4)]; gisaid_df

#write.csv(gisaid_df,"~/Desktop/Covid_Genomics_APHL/GISAID_Uploads/resubs/CAOC_Keywords_GISAID.csv",row.names=FALSE)
